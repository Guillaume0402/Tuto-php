...
<footer class="main-footer">
    <div class="footer-container">
        <div class="footer-section">
            ...
            <nav class="footer-nav">
                <ul>
                    <li><a href="<?= SITE_ROOT ?>">Accueil</a></li>
        ...
        <div class="footer-section">
            ...
            <ul>
                ...
                <li><a href="<?= BASE_URL ?>pages/politique-confidentialite.php">Politique de confidentialité</a></li>
    ...
    <div class="footer-bottom">
        ...
        <p class="version">
            ...
            <a href="<?php echo defined('SITE_GITHUB') ? SITE_GITHUB : 'https://github.com/votre-repo/tuto-php'; ?>" target="_blank" rel="noopener noreferrer">
