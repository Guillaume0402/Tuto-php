...
<body<?= isset($moduleClass) ? ' class="' . $moduleClass . '"' : '' ?>>
    <header class="header">
        <div class="header__container">
            <a href="<?= SITE_ROOT ?>" class="header__logo"><span class="header__logo--blue">Tuto</span><span class="header__logo--white">PHP</span></a>
            <nav class="header__nav">
                <a href="<?= SITE_ROOT ?>" class="header__link">Accueil</a>
